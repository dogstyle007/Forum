...
class ForumController extends Controller
{
    ...
    public function saveReply(CreateReplyRequest $request)
    {
        ...
        if( $post )
        {
            ...
            notify()->flash('<h3>Reply saved successfully</h3>', 'success', ['timer' => 2000]);
    ...
    public function deleteQuestion(Request $request)
    {
        try
        {
            ...
            if(Auth::user()->id == $post->user_id )
            {
                ...
                notify()->flash('<h3>Post removed successfully</h3>', 'success', ['timer' => 2000]);
            }
    ...
    public function deleteReply(Request $request)
    {
        try
        {
            ...
            if(Auth::user()->id == $reply->user_id )
            {
                ...
                notify()->flash('<h3>Reply removed successfully</h3>', 'success', ['timer' => 2000]);
            }
